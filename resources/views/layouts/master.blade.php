...
<head>
  ...
  <link rel="apple-touch-icon"
        sizes="144x144"
        href="{{ asset('copy/dce5jani6jm7e.cloudfront.net/images/public/AM-144x144.png')}}">
  <link rel="apple-touch-icon"
        sizes="152x152"
        href="{{ asset('copy/dce5jani6jm7e.cloudfront.net/images/public/AM-152x152.png') }}">
  <link rel="apple-touch-icon"
        sizes="192x192"
        href="{{ asset('copy/dce5jani6jm7e.cloudfront.net/images/public/AM-192x192.png') }}">
  ...
  <link rel="stylesheet" href="{{ asset('copy/dce5jani6jm7e.cloudfront.net/build/am-prod/layout2a4a.css?v=5197d60a846eb47dbb996ae68f751aa5')}}">
  <link rel="stylesheet" href="{{ asset('copy/dce5jani6jm7e.cloudfront.net/build/am-prod/common67cd.css?v=f43a3305fd477b5d64da32c456f8a442') }}">
...
<main-menu class="is-loading">
  ...
  <div class="info-wrapper show-full-text">
    <span class="folded-text">
      <b>81%</b>
      <b> of retail accounts lose money when trading CFDs on their own.</b>
    </span>
    <span class="fulltext">
      CFDs are complex instruments and come with a high risk due to leverage.
      <b>81%</b>
      <b>of retail investor accounts lose money when trading CFDs on their own.</b>
  ...
  <div class="mp-drop-element mp-menu-regulators">
   ...
   <span class="mp-vertscore"></span>
    ...
    <div class="mp-components">
      <a href="mailto:info@admiralmarketspro.com" class="mp-contacts">
  Contact us
</a>
      ...
      <a id="btn_log_in_header" data-cy="signup" class="undecorated is-guest" href="{{ route('login') }}">
        <am-button color="primary" variant="text" class="mp-sign-in">
          Login
        </am-button>
      </a>
      <a id="btn_start_trading_header" class="undecorated is-guest" href="{{ route('register')}}">
  ...
  <div class="container">
    <a id="btn_log_in_header_mobile" class="is-guest mp-sign-in" href="{{ route('login')}}">
    ...
    <div class="mp-logo">
    <a href="/">
      <img src="https://dce5jani6jm7e.cloudfront.net/app/common-assets/logo19/desktop/com.svg" 
      alt="adm-logo"/>
    </a>
    </div>
    ...
    <a data-cy="nav_main_analytics.index" class="mp-nav-text" href="{{ route('login') }}">
      Log In
        ...
        <div class="mp-sidebar-buttons">
          <a id="btn_log_in_menu_mobile" class="undecorated is-guest" href="{{ route('login')}}">
            <am-button color="primary" variant="text" class="mp-sign-in mp-sign-in-sidebar">
              Login
            </am-button>
          </a>
          <a id="btn_start_trading_menu_mobile" class="undecorated is-guest" data-cy="signup-mobile" href="{{ route('register') }}">
...
<footer class="am-footer">
    ...
    <div class="am-footer-top-line">
        ...
        <p>
            All references on this site to ‘Admiral Markets’ refer jointly to Admiral Markets UK Ltd, Admiral Markets Cyprus Ltd and Admiral Markets PTY Ltd. Admiral Markets’ investment firms are fully owned by <a rel="nofollow">Admiral Markets Group AS.</a>
        </p>
    </div>
    ...
    <script id="ze-snippet" src="{{ asset('copy/static.zdassets.com/ekr/snippetaae9.js?key=220f7c41-7204-4ffa-9c22-b511814bd051')}}"></script>
